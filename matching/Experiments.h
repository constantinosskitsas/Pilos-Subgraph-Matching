...
public:
    ...
    static matching_algo_outputs experiment3(const string data_graph_path,const std::string query_graph_path,const std::string filter,const std::string eigen,ui* order_pointer,string alpha,string beta,string thnum);
